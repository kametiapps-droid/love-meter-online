  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "blog-trust-building": path.resolve(__dirname, "blog/trust-building-relationships.html"),
        "blog-emotional-intelligence": path.resolve(__dirname, "blog/emotional-intelligence-love.html"),
