...
import { Calendar, Clock, User, ArrowLeft, Heart, Sunset, Music, Utensils, Mountain, Palette } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col romantic-gradient-bg relative overflow-hidden">
      ...
      <main className="flex-1 relative z-10">
        <article className="py-8 md:py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card-romantic rounded-2xl overflow-hidden">
              <div className="aspect-video overflow-hidden">
                <ResponsiveImage
                  src={blogImage}
                  alt="Romantic dinner date under moonlight"
              ...
              <div className="p-6 md:p-10">
                <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6 flex-wrap">
                  <span className="px-3 py-1 bg-primary/10 text-primary rounded-full font-medium">Date Ideas</span>
                  <span className="flex items-center gap-1"><Calendar className="w-4 h-4" /> December 9, 2025</span>
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      <Link to="/blog/relationship-goals-couples" className="text-primary hover:underline font-medium">Volunteer together</Link> for a cause you both care about. Whether it is serving meals at a homeless shelter, cleaning up a local park, or helping at an animal rescue, giving back together creates a deep sense of shared purpose and allows you to see each other's compassionate side. Research shows that couples who engage in altruistic activities together feel more connected and report higher relationship satisfaction.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
          ...
          <BlogInlineLinks postId="romantic-date-ideas" />
        </article>
