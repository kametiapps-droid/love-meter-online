...
import { Calendar, Clock, User, ArrowLeft, Heart, MessageSquare, Shield, Lightbulb, Users } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col romantic-gradient-bg relative overflow-hidden">
      <SEO
        ...
        description="Master healthy communication in your relationship. Learn active listening, conflict resolution, and emotional intelligence skills that strengthen love bonds."
      ...
      <main className="flex-1 relative z-10">
        <article className="py-8 md:py-16 px-4">
            ...
            <div className="card-romantic rounded-2xl overflow-hidden">
              ...
              <div className="p-6 md:p-10">
                <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6 flex-wrap">
                  <span className="px-3 py-1 bg-primary/10 text-primary rounded-full font-medium">Communication</span>
                  <span className="flex items-center gap-1"><Calendar className="w-4 h-4" /> March 24, 2026</span>
          ...
          <BlogInlineLinks postId="healthy-communication-relationships" />
        </article>
