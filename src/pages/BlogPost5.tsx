...
import { Calendar, Clock, User, ArrowLeft, Heart, MessageCircle, Gift, HandHeart, Timer } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col romantic-gradient-bg relative overflow-hidden">
      ...
      <main className="flex-1 relative z-10">
        <article className="py-8 md:py-16 px-4">
            ...
            <div className="card-romantic rounded-2xl overflow-hidden">
              ...
              <div className="p-6 md:p-10">
                <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6 flex-wrap">
                  ...
                  <span className="flex items-center gap-1"><Calendar className="w-4 h-4" /> December 23, 2025</span>
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                  <section className="mb-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      The five love languages are <Link to="/blog/healthy-communication-relationships" className="text-primary hover:underline font-medium">Words of Affirmation</Link>, Acts of Service, Receiving Gifts, Quality Time, and <Link to="/blog/science-of-attraction" className="text-primary hover:underline font-medium">Physical Touch</Link>. While most people appreciate all five to some degree, everyone has one or two primary love languages that resonate most deeply with them. When your partner expresses love in your primary language, it fills your "emotional love tank" and makes you feel truly loved and valued.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      The challenge many couples face is that they often speak different love languages. You might show your love by doing household chores (Acts of Service), while your partner craves heartfelt compliments (Words of Affirmation). Neither person is wrong — they are simply speaking different emotional dialects. Learning to recognize and speak your partner's love language is one of the most powerful skills you can develop for a <Link to="/blog/love-relationships-guide" className="text-primary hover:underline font-medium">lasting, <Link to="/blog/love-relationships-guide" className="text-primary hover:underline font-medium">happy relationship</Link></Link>.
                    </p>
                  </section>
          ...
          <BlogInlineLinks postId="five-love-languages" />
        </article>
