          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-4 text-sm text-muted-foreground mb-4">
                <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-xs font-medium">Name Meanings</span>
                <span className="flex items-center gap-1"><Calendar className="w-3 h-3" /> February 14, 2026</span>
              ...
              <p className="text-lg text-muted-foreground">Explore the fascinating stories behind popular names, their cultural origins, and how they shape our identity and relationships.</p>
            </div>
            ...
            <div className="prose prose-lg max-w-none card-romantic rounded-2xl p-6 md:p-10">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  <strong>Liam</strong> — Originally an Irish shortened form of William, Liam means "strong-willed warrior" or "protector." It has become the most popular baby name in the United States in recent years, resonating with parents who admire its combination of strength and simplicity.
                </p>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  The name Romeo, immortalized by Shakespeare's tragic love story, has become synonymous with romantic devotion. Its Italian origin means "pilgrim to Rome," but its cultural meaning far transcends its literal translation. Similarly, Juliet (meaning "youthful") has become the archetype of devoted love, inspiring countless adaptations and retellings across every medium.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
