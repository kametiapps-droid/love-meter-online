            ...
            <div className="space-y-4">
              <div className="card-romantic rounded-xl p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Our generator combines parts of both names to create unique, celebrity-style couple names. Just enter both names and get creative mashup suggestions instantly!
                </p>
              </div>
            </div>
          </div>
