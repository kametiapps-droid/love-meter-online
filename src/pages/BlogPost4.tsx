...
import { Calendar, Clock, User, ArrowLeft, Heart, Star, Sparkles, TrendingUp, Globe } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col romantic-gradient-bg relative overflow-hidden">
      ...
      <main className="flex-1 relative z-10">
        <article className="py-8 md:py-16 px-4">
            ...
            <div className="card-romantic rounded-2xl overflow-hidden">
              ...
              <div className="p-6 md:p-10">
                <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6 flex-wrap">
                  <span className="px-3 py-1 bg-primary/10 text-primary rounded-full font-medium">Fun Facts</span>
                  <span className="flex items-center gap-1"><Calendar className="w-4 h-4" /> December 30, 2025</span>
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                  <section className="mb-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      Did you know that <Link to="/blog/science-of-attraction" className="text-primary hover:underline font-medium">falling in love</Link> produces a bio<Link to="/blog/science-of-attraction" className="text-primary hover:underline font-medium">chemical response</Link> similar to taking certain stimulant substances? When you fall in love, your brain releases a cocktail of chemicals including dopamine, oxytocin, serotonin, and adrenaline. This chemical surge is why new love feels so intoxicating — your brain is literally giving you a natural high. Research from the Kinsey Institute found that the brain of a person falling in love looks remarkably similar to the brain of someone experiencing euphoria.
                    </p>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Online dating has transformed how people find love. Studies show that approximately 30 percent of <Link to="/blog/first-date-tips" className="text-primary hover:underline font-medium">relationships now begin online</Link>, and couples who meet online are statistically slightly more likely to stay together than those who meet through traditional means. The reason may be that online platforms allow people to filter for compatibility factors before meeting, leading to better-matched partnerships from the start.
                    </p>
                  </section>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      Being in a loving relationship is genuinely good for your health. Research from Harvard Medical School's 80-year-long study on happiness found that the <Link to="/blog/love-relationships-guide" className="text-primary hover:underline font-medium">quality of our close relationships</Link> is the single biggest predictor of our health and happiness as we age. People in strong, loving relationships have lower rates of heart disease, better immune function, and even longer lifespans than those who are lonely or in conflict-filled relationships.
                    </p>
                    <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <BlogInlineLinks postId="love-facts-trivia" />
        </article>
