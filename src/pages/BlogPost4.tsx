              ...
              <div className="p-6 md:p-10">
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                  <section className="mb-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      Did you know that <Link to="/blog/science-of-attraction" className="text-primary hover:underline font-medium">falling in love produces a biochemical response</Link> similar to taking certain stimulant substances? When you fall in love, your brain releases a cocktail of chemicals including dopamine, oxytocin, serotonin, and adrenaline. This chemical surge is why new love feels so intoxicating — your brain is literally giving you a natural high. Research from the Kinsey Institute found that the brain of a person falling in love looks remarkably similar to the brain of someone experiencing euphoria.
                    </p>
                    <p className="text-muted-foreground leading-relaxed mb-4">
