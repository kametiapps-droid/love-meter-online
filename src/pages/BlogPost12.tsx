          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              <div className="flex items-center gap-4 text-sm text-muted-foreground mb-4">
                <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-xs font-medium">Romance</span>
                <span className="flex items-center gap-1"><Calendar className="w-3 h-3" /> March 5, 2026</span>
              ...
              <p className="text-lg text-muted-foreground">Master the timeless art of writing love letters that capture your deepest feelings and make your partner's heart sing.</p>
            </div>

            <div className="rounded-2xl overflow-hidden mb-10">
              <img src={blogImage} alt="Handwritten love letter with fountain pen and rose petals" className="w-full h-64 md:h-96 object-cover" loading="lazy" />
            </div>
