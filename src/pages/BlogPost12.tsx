              ...
              <div className="p-6 md:p-10">
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      Open your letter by telling your partner why you're writing. Maybe it's their birthday, your <Link to="/blog/anniversary-celebration-ideas" className="text-primary hover:underline font-medium">anniversary</Link>, or simply a random Tuesday when you couldn't stop thinking about how lucky you are. Some beautiful opening lines: "I'm writing this because some feelings are too big for a text message." "Today I caught myself smiling just thinking about you, and I wanted you to know why." "There are things I want to say that I struggle to express out loud."
                    </p>
