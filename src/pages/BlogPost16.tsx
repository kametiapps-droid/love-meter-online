...
import { Calendar, Clock, User, ArrowLeft, Heart, Diamond, Sparkles, MapPin, Camera } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card-romantic rounded-2xl overflow-hidden">
              <div className="aspect-video overflow-hidden">
                <ResponsiveImage
                  src={blogImage}
                  alt="Romantic marriage proposal at sunset on the beach"
              ...
              <div className="p-6 md:p-10">
                <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6 flex-wrap">
                  <span className="px-3 py-1 bg-primary/10 text-primary rounded-full font-medium">Proposals</span>
                  <span className="flex items-center gap-1"><Calendar className="w-4 h-4" /> May 21, 2026</span>
