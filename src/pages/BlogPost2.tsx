...
import { Calendar, Clock, User, ArrowLeft, Star, Moon, Sun, Flame } from "lucide-react";
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                  <section className="mb-8">
                    <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                      <Star className="w-6 h-6 text-primary" /> Introduction to Zodiac Compatibility
                    </h2>
                  ...
                  <section className="mb-8">
                    <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                      <Flame className="w-6 h-6 text-primary" /> Fire Signs: Aries, Leo, and Sagittarius
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                      <Moon className="w-6 h-6 text-primary" /> Earth Signs: Taurus, Virgo, and Capricorn
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                      <Sun className="w-6 h-6 text-primary" /> Air Signs: Gemini, Libra, and Aquarius
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                      <Moon className="w-6 h-6 text-primary" /> Water Signs: Cancer, Scorpio, and Pisces
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                      <Star className="w-6 h-6 text-primary" /> Beyond Sun Signs: The Complete Picture
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
