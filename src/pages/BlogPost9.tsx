...
import { Calendar, Clock, User, ArrowLeft, Heart, Flame, MessageCircle, Gift, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col romantic-gradient-bg relative overflow-hidden">
      ...
      <main className="flex-1 relative z-10">
        <article className="py-8 md:py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card-romantic rounded-2xl overflow-hidden">
              <div className="aspect-video overflow-hidden">
                <ResponsiveImage
                  src={blogImage}
                  alt="Romantic couple dancing in candlelit room"
          ...
          <BlogInlineLinks postId="keep-spark-alive-relationship" />
        </article>
